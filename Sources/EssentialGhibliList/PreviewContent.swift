...
extension GhibliListItem {
    static let castleInTheSky: Self = .init(
        ...
        film: URL(string: "https://ghibliapi.herokuapp.com/films/2baf70d1-42bb-4437-b551-e5fed5a87abe")!
    )
    ...
    static let kikisDeliveryService: Self = .init(
        ...
        film: URL(string: "https://ghibliapi.herokuapp.com/films/ea660b10-85c4-4ae3-8a5f-41cea3648e3e")!
    )
}
#endif
